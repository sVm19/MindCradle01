    ...
    <div className="min-h-screen flex items-center justify-center bg-bg relative overflow-hidden">
      ...
      <div className="w-full max-w-[380px] mx-auto px-6 relative z-10 animate-fadeIn">
        ...
        <div className="bg-bg2 border border-border rounded-[24px] px-8 py-8">
          <div className="text-xs text-accent tracking-[0.1em] uppercase mb-2">Welcome back</div>
          <h1 className="text-2xl font-light text-text mb-6">Sign in</h1>
        ...
        <p className="text-center text-sm text-text3 mt-6">
          New here?{' '}
          <Link to="/signup" className="text-accent hover:text-accent2 transition-colors">
            Create an account
          </Link>
        </p>
      </div>
